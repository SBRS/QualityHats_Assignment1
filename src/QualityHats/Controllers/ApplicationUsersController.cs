...
namespace QualityHats.Controllers
{
    public class ApplicationUsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AccessFailedCount,Address,ConcurrencyStamp,Email,EmailConfirmed,Enabled,FirstName,HomeNumber,LastName,LockoutEnabled,LockoutEnd,MobileNumber,NormalizedEmail,NormalizedUserName,PasswordHash,PhoneNumber,PhoneNumberConfirmed,SecurityStamp,TwoFactorEnabled,UserName,WorkNumber")] ApplicationUser applicationUser)
        {
